...
ROOK_EXTERNAL_USERNAME=client.healthchecker
ROOK_EXTERNAL_CEPH_MON_DATA=pve01=10.1.115.11:3300
ROOK_EXTERNAL_DASHBOARD_LINK=http://10.1.115.12:8080/
...
CSI_RBD_NODE_SECRET_NAME=csi-rbd-node-main-k8s
CSI_RBD_PROVISIONER_SECRET_NAME=csi-rbd-provisioner-main-k8s
CEPHFS_POOL_NAME=k8sfs_data
CEPHFS_METADATA_POOL_NAME=k8sfs_metadata
CEPHFS_FS_NAME=k8sfs
RESTRICTED_AUTH_PERMISSION=true
CSI_CEPHFS_PROVISIONER_SECRET_NAME=csi-cephfs-provisioner-main-k8sfs
CSI_CEPHFS_NODE_SECRET_NAME=csi-cephfs-node-main-k8sfs
MONITORING_ENDPOINT=10.1.115.12
MONITORING_ENDPOINT_PORT=9283
RBD_POOL_NAME=k8s
